        ...
        value: function render() {
            ...
            if ((0, _unsafe.isUnsafe)(this.props.children)) {
                ...
                return _react2['default'].createElement(
                    'td',
                    mergedProps,
                    _react2['default'].createElement(this.props.formatter, _extends({}, mergedProps, { tableData: this.props.tableData, rowData: this.props.rowData, data: this.props.children }))
                );
            } else {
                return _react2['default'].createElement(
                    'td',
