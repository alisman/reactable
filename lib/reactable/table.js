        ...
        value: function render() {
            ...
            if (this.data && typeof this.data.map === 'function') {
                ...
                children = children.concat(this.data.map((function (rawData, i) {
                    ...
                    return _react2['default'].createElement(_tr.Tr, _extends({ columns: columns, key: i, tableData: this.data, data: data, columnFormatters: this.props.columnFormatters }, props));
                }).bind(this)));
            }
